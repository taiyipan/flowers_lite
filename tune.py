...
print("Number of layers in the base model: {}".format(base_layers))

unfreeze_layers = 10
fine_tune_at = base_layers - unfreeze_layers
print('Fine tune from layer {} onwards'.format(fine_tune_at))
